...
<body>
    <div id="portada">
        <img src="imagenes/portada-rubor.jpg" alt="portada-productos" class="d-block auto img-fluid pb-3 pt-5">
    </div>
